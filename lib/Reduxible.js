          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                context = { config: _this2.config, history: history, req: req, res: res, next: next };
                store = _this2.storeFactory.createStore({}, [(0, _contextMiddlerware2.default)(context), (0, _reactRouterRedux.routerMiddleware)(history)]);
                _context.next = 8;
