...
var ReduxibleRouter = function () {
  ...
  ReduxibleRouter.prototype.preInitialize = function () {
    var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(store, components) {
      var initialActions, willDispatch;
      return _regenerator2.default.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              initialActions = [].concat(this.extractActions(components), [(0, _contextService.initialize)()]);
              willDispatch = initialActions.map(function (action) {
            ...
            case 8:
              ...
              (0, _warning2.default)(_context4.t0.stack);
              _context4.next = 14;
              return _promise2.default.reject(_context4.t0);
    ...
    function preInitialize(_x6, _x7) {
      return ref.apply(this, arguments);
    }
  ...
  ReduxibleRouter.prototype.extractActions = function extractActions(components) {
  ...
  ReduxibleRouter.renderComponent = function renderComponent(_ref5) {
  ...
  ReduxibleRouter.prototype.getRouter = function getRouter(renderProps, routes, history) {
    return _react2.default.createElement(_Router2.default, (0, _extends3.default)({}, renderProps, { routes: routes, history: history }));
  };

  ReduxibleRouter.prototype.getRouterWithDevTools = function getRouterWithDevTools(renderProps, routes, history) {
